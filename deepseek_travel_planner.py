...
Focus on useful, realistic, and actionable travel tips including safety, transportation, budgeting, local etiquette, and preparation.
Provide tips on:
...
7. Making the most of layovers and short trips""",
            "Budget Planning": """You are a travel budget planner who helps users estimate and organize trip costs.
Provide a clear budget breakdown for accommodation, food, transportation, activities, shopping, and emergency expenses.""",
...
def main():
    ...
    st.title("+ Local DeepSeek R1 Travel Assistant")
    st.markdown(
        """
...
"""
    ...
    system_prompts = planner.get_system_prompts()
    example_prompts = planner.get_example_prompts()
        ...
        if user_prompt:
            with st.spinner("Planning your trip..."):
                with output_container:
                    planner.process_request(system_prompts[mode], user_prompt)
        else:
